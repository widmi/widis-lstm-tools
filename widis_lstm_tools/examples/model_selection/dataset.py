...
class RandomOrSineEncoded(Dataset):
    def __init__(self, n_samples: int, min_seq_len: int = 10, max_seq_len: int = 100, n_features: int = 16):
        ...
        Dataset with sequences of different lengths containing a random uniform signal or a sine signal. Signal values
        ...
        """
        super(RandomOrSineEncoded, self).__init__()
